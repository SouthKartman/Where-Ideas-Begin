...
<div class ="Mainhead" id="element">
    ...
    <li class="is-active"><span>JQuery</span></li>  
    ...
    <div class="readblocktext">
      ...
      <div class="content">
         <div class="anim-show">
          <div class="opred"><p>jQuery — это замечательный JavaScript Framework, который подкупает своей простотой в понимании и удобством в использовании. Но изучение надо с чего-то начинать.</p></div>
    
     <div class="imageblock">
        <img src="imagejs/4.jpg" width="100%" alt="lklklk">
        </div>
    </div> 
    </div>
    ...
    <a href="#" class="buttonns" id="link_Id" >Читать дальше</a>
      ...
      <div class="content">
         ...
         <div class="noopred">
          ...
          Синтаксис jQuery предназначен для упрощения навигации по документу, выбора элементов DOM, создания анимации, обработки событий и разработки анимация. jQuery также предоставляет разработчикам возможность создавать подключаемые модули поверх библиотеки JavaScript. Это позволяет разработчикам создавать абстракции для низкоуровневого взаимодействия и анимации, расширенных эффектов и высокоуровневых, тематических виджетов. Модульный подход к библиотеке jQuery позволяет создавать мощные динамические веб-страницы и веб-приложения.
    ...
    <div class="First">
      <div class="anim-show">
       ...
       <!-- <p class="ZagWidget">Тест по первой теме HTML</p>  Теста нет так как мало инфы -->
