...
<div class ="Mainhead" id="element">
    ...
    <li class="is-complete"><span>Тест на JS</span></li>
    <li class="is-active"><span>Скрипт блоков</span></li>
    ...
    <div class="readblocktext">
      ...
      <div class="nameredacktor">
              ...
              <div class="content">
                  <div class="anim-show">
              <div class="opred"><p>Появление элементов при скролле.</p></div>   
             </div>
             </div>
      ...
      <div class="content">
         ...
         <div class="noopred">
          ...
          <div class="imageblock">
            <img src="imagejs/11.jpg" width="100%" alt="lklklk">
          </div>
    ...
    <div class="content">
         <div class="anim-show">
          Появление элементов при прокрутке страницы: добавляем начальный CSS <br>
          В CSS мы, во-первых, зададим большим блокам высоту, чтобы у нас на странице появился скролл. Это нужно только для демонстрации. <br>
          ...
          <div class="imageblock">
            <img src="imagejs/12.jpg" width="100%" alt="lklklk">
          </div>
    ...
    <div class="content">
      <div class="anim-show">
        Появление контента при скроллинге: работаем с JS <br>
        Нам повезло, веб не стоит на месте и регулярно улучшается, делая нашу жизнь чуточку проще. Если раньше нам нужно было сильно повозиться, чтобы реализовать плавное появление элементов при скролле страницы, то теперь все стало намного понятнее. Я не буду сильно углубляться, если хотите, можете почитать отдельно про Intersection Observer. С помощью этого мы можем отслеживать видимость элемента в условном «окне» пользователя. И благодаря этому мы можем делать не только анимацию, но и, например, отложенную загрузку, либо «бесконечный» скролл. <br>
        Но вернемся к нашей теме. Вставим в JS следующий код:
        
       <div class="imageblock">
         <img src="imagejs/13.jpg" width="100%" alt="lklklk">
       </div>

       Здесь мы цепляемся за класс .element-animation и будем следить, доступен он на «экране» или нет. Обратите внимание, что вы можете использовать этот класс сразу к нескольким элементам.Итак, когда пользователь доскроллил до класса .element-animation, то мы добавляем ему класс .element-showВот и все, что делает JS. Проверяет виден ли класс и если да, то добавляет к нему еще один класс. <br>
 ...
 <div class="content">
  <div class="anim-show">
    Появление элементов на сайте: заключительный шаг <br>
   ...
   <div class="imageblock">
     <img src="imagejs/14.jpg" width="100%" alt="lklklk">
   </div>
   Bот и все, теперь наш блок будет видимым, когда до него доскроллит пользователь. Если хотите, вы можете сделать так, чтобы элемент появлялся снизу:
   <div class="imageblock">
    <img src="imagejs/15.jpg" width="100%" alt="lklklk">
   </div>
